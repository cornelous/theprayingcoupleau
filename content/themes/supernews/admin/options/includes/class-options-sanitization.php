...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'supernews' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'supernews' ),
		'repeat-y'  => __( 'Repeat Vertically', 'supernews' ),
		'repeat'    => __( 'Repeat All', 'supernews' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'supernews' ),
		'top center'    => __( 'Top Center', 'supernews' ),
		'top right'     => __( 'Top Right', 'supernews' ),
		'center left'   => __( 'Middle Left', 'supernews' ),
		'center center' => __( 'Middle Center', 'supernews' ),
		'center right'  => __( 'Middle Right', 'supernews' ),
		'bottom left'   => __( 'Bottom Left', 'supernews' ),
		'bottom center' => __( 'Bottom Center', 'supernews' ),
		'bottom right'  => __( 'Bottom Right', 'supernews')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'supernews' ),
		'fixed'  => __( 'Fixed in Place', 'supernews')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'supernews' ),
		'italic'      => __( 'Italic', 'supernews' ),
		'bold'        => __( 'Bold', 'supernews' ),
		'bold italic' => __( 'Bold Italic', 'supernews' )
		);
