<?php get_header(); ?>
	...
	<?php $layout = of_get_option( 'supernews_search_layout', 'standard' ); ?>
	...
	<div id="primary" class="content-area column">
		...
		<?php if ( have_posts() ) : ?>
			...
			<h3 class="section-title"><strong><?php printf( __( 'Search Results for: %s', 'supernews' ), '<span>' . get_search_query() . '</span>' ); ?></strong></h3>
