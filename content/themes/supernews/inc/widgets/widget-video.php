 ...
 * @since      1.0.0
 */
class SuperNews_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-supernews-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'supernews' )
		);

		// Create the widget.
		$this->WP_Widget(
			'supernews-video',                  // $this->id_base
			__( '&raquo; Video', 'supernews' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'supernews' ),
			'video_url'  => '',
			'video_code' => ''
		);
